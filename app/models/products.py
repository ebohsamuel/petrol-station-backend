...
class Products(Base):
    ...
    latest_price: Mapped[float] = mapped_column(nullable=True)  # updated when price changes. replace the present
    # value with the new value to update record
    ...
    product_collection_requests: Mapped[list["ProductCollectionRequest"]] = relationship(
